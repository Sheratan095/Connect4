...
/*
 * Render a nicely aligned ASCII grid for the board.
 * Cells look like: | ⬤ | and rows/columns are separated by +---+ lines.
 * This keeps output aligned even for multi-character pawn strings (most terminals
 * will handle emoji width reasonably; for very wide glyphs alignment may vary).
 */
